...
function PurchaseQuotations() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8090/purchasequotation/getpendingrequest').then(res => {
            console.log(res);
    ...
    const setActive=(id)=>{
        ...
        axios.put(`http://localhost:8090/purchasequotation/setaccept/${id}`).then((res)=>{
        alert("Purchase Quotation Accepted By Supplier Manager").catch(err=>{
           alert("Error")
        });
        });
    ...
    const setDecline=(id)=>{
        ...
        axios.put(`http://localhost:8090/purchasequotation/setdecline/${id}`).then((res)=>{
        alert("Purchase Quotation Declined By Supplier Manager").catch(err=>{
           alert("Error")
        });
        });
  ...
  <div class="top-bar">
        ...
        <div className="SupplierRequests">
            ...
            <center><h2>Purchase Quotations</h2></center>
            {/* <div className='row'>
