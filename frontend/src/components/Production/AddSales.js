...
const AddSales = (props) => {
    ...
    const submitbtnHandler = () => {
        axios.post("http://localhost:8090/product/dailySales", numProducts).then((response) => {
            swal({
                title: "Success!",
            ...
            swal({
                title: "Error!",
                text: "Couldn't add the daily sales. Please try again",
                icon: 'error',
                timer: 2000,
                button: false
            });
    ...
    return (
        <div className={classes.AddProductionModal} id="AddSalesModal">
            <div className={classes.AddProductionModalContent}>
                <h3 className={classes.AddProductionModalContentH3}>Add Daily Sales</h3>
