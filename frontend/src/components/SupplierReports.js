...
function SupplierReports() {
    ...
    useEffect(() => {
        Axios.get('http://localhost:8090/supplierquotation/getactivequotations').then(res => {
    ...
    return (
      ...
      <div className="SupplierRequests"> 
            ...
            <center>
            <a href='/printPage'  class="btn btn-success ">Genarate Active Quotations Report</a>
            </center>
                ...
                <tbody>

                    {
                        suppliersreports.map(supplierquotaton => <tr key={suppliersreports._id}>
                            ...
                            <center>
                           <a href='' onClick={(e) => { onDelete(supplierquotaton._id, e) }} class="btn btn-danger ">Delete</a>
                           </center>
                            </td>
